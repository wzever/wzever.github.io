...
.publication-tag { position: relative; overflow: hidden; display: inline-flex; align-items: center; justify-content: flex-start; gap: .3rem; width: 5.25rem; min-width: 5.25rem; box-sizing: border-box; padding: .45rem .5rem; color: #64748b; background: #fff; border: 1px solid #dbe3ec; border-radius: 6px; box-shadow: 0 3px 10px rgba(23,43,77,.04); font-size: .68rem; font-weight: 650; letter-spacing: .035em; line-height: 1; }
